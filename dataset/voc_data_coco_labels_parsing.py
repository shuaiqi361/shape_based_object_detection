...
voc_labels_coco_dict = {'aeroplane': 'airplane', 'bicycle': 'bicycle', 'bird': 'bird', 'boat': 'boat',
...
def parse_annotation(annotation_path):
    ...
    for object in root.iter('object'):
        ...
        ori_label = object.find('name').text.lower().strip()
        label = voc_labels_coco_dict[ori_label]  # convert label name to coco convention
...
if __name__ == '__main__':
    ...
    output_folder = '/home/keyi/Documents/research/code/shape_based_object_detection/data/VOCOCO'
