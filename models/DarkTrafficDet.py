...
class DarkTrafficDetectorLoss(nn.Module):
    """
    ...
    def __init__(self, priors_cxcy, config, threshold=0.4, neg_pos_ratio=2, theta=0.1):
        super(DarkTrafficDetectorLoss, self).__init__()
    ...
    def compute_odm_loss(self, odm_locs, odm_scores, boxes, labels, ignored_regions):
        ...
        for i in range(batch_size):
            ...
            ignored_overlap = find_jaccard_overlap(ignored_regions[i], self.priors_xy)  # overlap of priors and ignored regions
