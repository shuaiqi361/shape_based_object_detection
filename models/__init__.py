...
from .SSD300_GCN import SSD300GCN, MultiBoxGCNLoss300
...
def model_entry(config):
    ...
    elif config.model['arch'].upper() == 'SSD300GCN':
        print('Loading SSD300 Graph Conv Net with VGG16 backbone ......')
        return SSD300GCN(config['n_classes'], config), MultiBoxGCNLoss300
