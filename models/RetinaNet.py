...
class RetinaNet(nn.Module):
    ...
    def create_anchors(self):
        ...
        prior_boxes = torch.FloatTensor(anchors).to(self.device)  # (49104, 4)
...
def resnet50(num_classes, config, pretrained=True, **kwargs):
    ...
    Args:
        ...
        :param num_classes:
    """
    model = RetinaNet(num_classes, Bottleneck, [3, 4, 6, 3], config.device)
    if pretrained:
